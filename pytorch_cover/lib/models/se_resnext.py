...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, num_group=1, reduction=16):
...
class BasicBlock_2(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, num_group=32, reduction=16):
...
def se_resnext_34(**kwargs):
    """Constructs a ResNeXt-50 model.
    """
    model = SE_ResNeXt(BasicBlock, [3, 4, 6, 3], **kwargs)
    return model
