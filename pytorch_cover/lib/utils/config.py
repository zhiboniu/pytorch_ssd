...
# labelmap_list = ["cover", "spray"]
labelmap_list = ["slagcar"]

print('work in pytorch_bce config file')
...
# __C.DATASET.DATASET_DIR = '/train/execute/Dangercar/cls_3main/data'
# train set scope
...
__C.AUGMENTATION.MAX_EXPAND = 2.0
__C.AUGMENTATION.MIN_TARGET_EDGE = 16
__C.AUGMENTATION.EXPAND_FREQUENCY = 3  # ONE IN SIX NOT EXPAND
__C.AUGMENTATION.EXPAND_PROB = 0.3  # RFB

#CROP params item: min_scale,max_scale,min_ratio,max_ratio,min_overlap
__C.AUGMENTATION.RATIO = __C.DATASET.IMAGE_SIZE[0]/__C.DATASET.IMAGE_SIZE[1]
__C.AUGMENTATION.CROP = (None,
    (0.8,1.0,__C.AUGMENTATION.RATIO,__C.AUGMENTATION.RATIO,0.3),
    (0.8,1.0,__C.AUGMENTATION.RATIO,__C.AUGMENTATION.RATIO,0.5),
    (0.8,1.0,__C.AUGMENTATION.RATIO,__C.AUGMENTATION.RATIO,0.7),
    (0.8,1.0,__C.AUGMENTATION.RATIO,__C.AUGMENTATION.RATIO,0.9))
...
__C.MODEL.PRETRAIN_MODEL = 'pretrain/vgg16_reducedfc.pth'

# -- Prior box option
# STEPS for the proposed bounding box
__C.MODEL.STEPS = [8, 16, 32, 64, 100, 300]
# a list from min value to max value
__C.MODEL.MIN_SIZES = [30, 45, 70, 110, 170, 250]
__C.MODEL.MAX_SIZES = [45, 70, 110, 170, 250, 350]
...
__C.MODEL.CLIP = False
__C.MODEL.FLIP = False
...
__C.EVAL.EVAL_NET = "/train/execute/evalnet/eval_ssd_score.py"
...
#     __C.DATASET.DATASET_DIR = osp.abspath(osp.join(__C.GENERAL.ROOT_DIR, 'data', __C.DATASET.SUB_DIR))
#     __C.DATASET.DATASET_DIR = __C.DATASET.DATASET_DIR
    __C.MODEL.NUM_CLASSES = __C.DATASET.NUM_CLASSES + 1
    __C.MODEL.IMAGE_SIZE = __C.DATASET.IMAGE_SIZE
