...
from lib.layers.modules import DetectLoss, matching, DetectLossPost, FocalLoss_BCE
...
parser.add_argument('--cfg_name', default='slagcover',
...
def adjust_learning_rate(optimizer, lr_origin, gamma, epoch,
    ...
    if epoch < warmup_epoch:
        ...
        print("adjust_learning_rate..., lr_origin:{}, gamma:{}, step_index:{}, new lr:{}".format(lr_origin,gamma,step_index,lr))
